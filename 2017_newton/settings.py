...
MASTER_FILE_PATH = '2017MasterIndividual'

#Used for drive time lookup. Use Column A from SchoolsExport.csv
HOST_SCHOOL_ID = 741 #NEWTON
...
#4
TWO_SCHOOL_ENTRIES_HAVE_SAME_JUDGES_PENALTY = 800
...
STAGE_1_MINUTES_PER_FLUSH = 10   #40
STAGE_1_HOURS             = 48   #7
STAGE_2_HOURS             = 0.5  #1
