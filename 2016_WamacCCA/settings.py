...
#Used for drive time lookup
HOST_SCHOOL_ID = 512 #Clear Creek Amana
...
CONTEST_SITENAME = ['Grinnell', 'Monticello', 'Cascade']
...
#5
BROKEN_RESTRICTION_PENALTY     = 3000
...
STAGE_1_ARRAY_SIZE        = 10    #10
STAGE_1_MINUTES_PER_FLUSH = 30
STAGE_1_HOURS             = 28   #7
STAGE_2_HOURS             = 2   #1
