...
HOST_SCHOOL_ID = 919 #West Des Moines Valley
...
CONTEST_SITENAME = ['Ankeny Centennial','Perry','Clarke Community','Council Bluffs Abraham Lincoln']
...
STAGE_1_MINUTES_PER_FLUSH = 3   #40
STAGE_1_HOURS             = 48   #7
STAGE_2_HOURS             = 0.5  #1
