...
MASTER_FILE_PATH = '2016MasterIndividual'

#Used for drive time lookup. Use Column A from SchoolsExport.csv
HOST_SCHOOL_ID = 559 #Dubuque Senior
...
CONTEST_SITENAME = ['AGWSR','North Butler, Greene','Clear Lake','Maquoketa Valley']
...
BEST_SCORE_PRINT_MINS     = 2     #5

STAGE_1_ARRAY_SIZE        = 12    #10
#STAGE_1_MINUTES_PER_FLUSH = 3   #40 Not used anymore
STAGE_1_HOURS             = 48   #7
STAGE_2_HOURS             = 0.5  #1
